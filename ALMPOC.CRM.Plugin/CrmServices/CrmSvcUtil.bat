...
C:\Infront\CRM2016\bin\CrmSvcUtil.exe /language:CS /url:https://nikogroupdev.api.crm4.dynamics.com/XRMServices/2011/Organization.svc /out:"XrmSdk.cs" /namespace:Niko.Plugin.CrmServices.XrmSdk /serviceContextName:ServiceContext /codewriterfilter:Infront.SvcUtilFilter.CodeWriterFilter,Infront.SvcUtilFilter /codecustomization:Infront.SvcUtilFilter.CustomizeCodeDomService,Infront.SvcUtilFilter
